...
export const TOKENS: IToken[] = [
  ...
  //
  {
    ...
    decimals: 18,
    logoURI:
      'https://raw.githubusercontent.com/ARYZEofficial/Token-Logos/refs/heads/main/Digital%20Cash/RYO/RYOPAY_CAD.svg',
    name: 'RYOPAY CAD',
    symbol: 'RYOCAD',
    companies: ['ryopay'],
    supportedRouterVersions: [3],
  ...
  },
  {
    ...
    decimals: 18,
    logoURI:
      'https://raw.githubusercontent.com/ARYZEofficial/Token-Logos/refs/heads/main/Digital%20Cash/RYO/RYOPAY_JPY.svg',
    name: 'RYOPAY JPY',
    symbol: 'RYOJPY',
    companies: ['ryopay'],
    supportedRouterVersions: [3],
